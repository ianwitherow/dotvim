...
<!-- saved from url=(0072)https://raw.github.com/skammer/vim-css-color/master/after/syntax/css.vim -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><style type="text/css"></style></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;">" Language:     Colored CSS Color Preview
